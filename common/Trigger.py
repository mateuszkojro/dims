...
def create_trigger_dict(dict):
    """ Creates trigger from dictionary field names need to be the same as @field_names """
    print("Check correctness")
    return Trigger(file=dict['file'],
                   start_frame=dict['start_frame'],
                   end_frame=dict['end_frame'],
                   bounding_rect=Rect(min_x=dict['box_min_x'],
                                      min_y=dict['box_min_y'],
                                      max_x=dict['box_max_x'],
                                      max_y=dict['box_max_y']),
